---
layout: post
title:  "Release T-Pot 19.03"
date:   2019-04-01 09:37:42
...
![Architecture](https://github.com/dtag-dev-sec/tpotce/blob/master/doc/architecture.png)
...
![Cockpit Terminal](https://github.com/dtag-dev-sec/tpotce/blob/master/doc/cockpit3.png)
...
![Dashbaord](https://github.com/dtag-dev-sec/tpotce/blob/master/doc/kibana.png)

<a name="tools"></a>
## Tools
We included some web based management tools to improve and ease up on your daily tasks.

![Cockpit Overview](https://github.com/dtag-dev-sec/tpotce/blob/master/doc/cockpit1.png)

![Cockpit Containers](https://github.com/dtag-dev-sec/tpotce/blob/master/doc/cockpit2.png)

![Cyberchef](https://github.com/dtag-dev-sec/tpotce/blob/master/doc/cyberchef.png)

![ES Head Plugin](https://github.com/dtag-dev-sec/tpotce/blob/master/doc/spiderfoot.png)

![Spiderfoot](https://github.com/dtag-dev-sec/tpotce/blob/master/doc/spiderfoot.png)
