---
layout: post
title:  "(Update) T-Pot: A Multi-Honeypot Platform"
...
Make sure that you invoke the following script as the user *tsec*. ***Do not run it as root or via sudo***. Otherwise the setup of two factor authentication won't work.
...
<br>Fix for (b): 
      chown tsec:tsec /home/tsec/.google_authenticator
